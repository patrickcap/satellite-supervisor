...
async def predict_air_quality(satellite: Satellite, api_key: str = Depends(APIKeyHeader(name='X-API-key'))) -> PostSatellitePurposeResponse | JSONResponse:  # pylint: disable=line-too-long
    ...
    return PostSatellitePurposeResponse(air_quality=_get_satellite_purpose_prediction(satellite))
